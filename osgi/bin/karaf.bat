...
set DEFAULT_JAVA_DEBUGS_OPTS=-agentlib:jdwp=transport=dt_socket,server=y,suspend=y,address=11015
    ...
    if "%IS_RUNNABLE%" == "true" (
        ...
        if %JAVA_VERSION% GTR 8 (
            "%JAVA%" %JAVA_OPTS% %OPTS% ^
                ...
                --patch-module java.base=lib/endorsed/org.apache.karaf.specs.locator-4.2.5.jar ^
                --patch-module java.xml=lib/endorsed/org.apache.karaf.specs.java.xml-4.2.5.jar ^
